      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          >
            ...
            <span className="text-lg font-medium text-gray-900 font-[800]">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500 font-[600]">
                If you're not satisfied with your purchase, we accept returns
                within 30 days of delivery. To initiate a return, please email
                us at support@saanalipasanka@gmail.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500 font-[600]">
                ...
                support@sanalipasanka@gmail.com, or by calling us at (976) 827-7434
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500 font-[600]">
                Currently, we only offer shipping within the SriLanka.
              </p>
            </div>
          )}
        </div>
